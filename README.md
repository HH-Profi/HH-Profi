...
Im Projekt liegen fertige Vorlagen, die du direkt herunterladen oder aus dem Repository kopieren kannst:

- `public/templates/spieler.csv`
- `public/templates/uebungen.csv`
- `public/templates/trainings.csv`

Nach der Installation sind die Vorlagen auch über den Browser erreichbar:

```text
http://<LXC-IP>:3000/templates/spieler.csv
http://<LXC-IP>:3000/templates/uebungen.csv
http://<LXC-IP>:3000/templates/trainings.csv
```
